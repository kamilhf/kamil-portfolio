                ...
                {contacts.map((c) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-sky-800 transition-colors group-hover:text-sky-600">
                        {c.label}
                      </p>
                    </div>
                    <svg
                      className="ml-auto h-4 w-4 text-sky-300 transition-colors group-hover:text-sky-500"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
